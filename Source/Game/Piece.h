...
public:
	...
	PieceInfo pieceInfo_[PIECE_MAX] =
	{
		...
		{1,7,PIECE_TYPE::HUHYO,		false},		//	味方歩兵
		...
		{8,2,PIECE_TYPE::KAKUGYO,	true},		//	敵角行
		{8,8,PIECE_TYPE::KAKUGYO,	false},		//	味方角行
		{2,2,PIECE_TYPE::HISHA,		true},		//	敵飛車
		{2,8,PIECE_TYPE::HISHA,		false},		//	味方飛車
		{1,1,PIECE_TYPE::KYOUSHA,	true},		//	敵香車
		{9,1,PIECE_TYPE::KYOUSHA,	true},
		{1,9,PIECE_TYPE::KYOUSHA,	false},		//	味方香車
		{9,9,PIECE_TYPE::KYOUSHA,	false},
		{2,1,PIECE_TYPE::KEIMA,		true},		//	敵桂馬
		{8,1,PIECE_TYPE::KEIMA,		true},
		{2,9,PIECE_TYPE::KEIMA,		false},		//	味方桂馬
		{8,9,PIECE_TYPE::KEIMA,		false},
		{3,1,PIECE_TYPE::GINSHO,	true},		//	敵銀将
		{7,1,PIECE_TYPE::GINSHO,	true},
		{3,9,PIECE_TYPE::GINSHO,	false},		//	味方銀将
		{7,9,PIECE_TYPE::GINSHO,	false},
		{4,1,PIECE_TYPE::KINSHO,	true},		//	敵金将
		{6,1,PIECE_TYPE::KINSHO,	true},
		{4,9,PIECE_TYPE::KINSHO,	false},		//	味方金将
		{6,9,PIECE_TYPE::KINSHO,	false},
		{5,1,PIECE_TYPE::GYOKUSHO,	true},		//	玉将
		{5,9,PIECE_TYPE::OUSHO,		false},		//	王将
